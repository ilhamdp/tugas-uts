...
$query = "SELECT tokenstem FROM `dokumen` where nama_file='./files/uu_nomor_16_tahun_1992_karantina_hewan_ikan_dan_tumbuhan.pdf'";
...
$query2 = "SELECT tokenstem  FROM `dokumen` where nama_file='./files/uu_nomor_32_tahun_2009_tentang_perlindungan_dan_pengelolaan_lingkungan_hidup.pdf'";
