 <?php
  ...
  function preproses($teks,$nama_file) { 
    ...
    //terapkan stop word removal
     ...
     $st = new IDNstemmer();
     $st2 = new Stemmer();
     $konek = mysqli_connect("sql304.epizy.com","epiz_21968555","24121996","epiz_21968555_dbstbi");
        ...
        if (strlen($filteredarray) >=4)
          {
            ...
            $hasil2=$st2->Enhanced_CS($hasil);
            // $st->doStemming($filteredarray)
            //  echo " ".$hasil.'<br>';
            $query = "INSERT INTO dokumen (nama_file, token, tokenstem) VALUES('$nama_file', '$filteredarray', '$hasil2')";
            echo ">>".$query;   
  ...
  if (move_uploaded_file($lokasi_file,"$folder")){
    echo "<center>Nama File : <br><b>$nama_file</b> <br>sukses di upload</center>";
